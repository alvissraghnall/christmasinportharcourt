                    ...
                    <div className="col-lg-5 mb-4 mb-lg-0">
                        ...
                        <ul className="list-group">
                            ...
                            <li className="list-group-item d-flex flex-column flex-sm-row align-items-center justify-content-between p-4">
                                ...
                                <h5 className="text-primary my-2 my-sm-0">₦10,000</h5>
                            ...
                            <li className="list-group-item d-flex flex-column flex-sm-row align-items-center justify-content-between p-4">
                                ...
                                <h5 className="badge bg-dark fs-5 fw-bold rounded px-3 py-0 my-3 my-sm-0">₦15,000</h5>
                                <div className="fs-sm">after Nov 30, 2022</div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="row py-xl-3">
                        <div className="col-xl-4 col-lg-5 offset-xl-1 order-lg-2 mb-4">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <p className="fs-xl text-light ps-3 mb-0">Hurry up! Early birds extended until November 30th, 2022.</p>
                            </div>
                        </div>
                        <div className="col-xl-6 col-lg-7 order-lg-1">
                            <div className="position-relative">
                                <div className="position-relative overflow-hidden rounded-3 zindex-5 py-5 px-4 p-sm-5">
                                    <span className="position-absolute top-0 start-0 w-100 h-100 bg-repeat-0 bg-position-center-start zindex-2" style={{backgroundImage: 'url(assets/img/price-card-left-bg.png)'}} />
                                    <span className="position-absolute top-0 end-0 w-100 h-100 bg-repeat-0 bg-position-center-end zindex-2" style={{backgroundImage: 'url(assets/img/price-card-right-bg.png)'}} />
                                    <div className="px-md-4 position-relative zindex-5">
                                        <div className="d-sm-flex align-items-start justify-content-between">
                                            <div className="text-center text-sm-start me-sm-4">
                                                <div className="lead text-primary fw-semibold text-uppercase mb-2">DEC. 24TH - 26TH</div>
                                                <h3 className="h1 text-heading">Christmas in Port Harcourt</h3>
                                            </div>
                                            <div className="d-table bg-white rounded-3 p-4 flex-shrink-0 mx-auto mx-sm-0">
                                                <img src="assets/img/qr-code.png" width={102} alt="QR Code" />
                                            </div>
                                ...
                                <span className="position-absolute bg-dark opacity-35 bottom-0 mb-n2 d-dark-mode-none" style={{left: '1.5rem', width: 'calc(100% - 3rem)', height: '5rem', filter: 'blur(.75rem)'}} />
                            </div>
                        </div>
                    </div>
                </div>
