                ...
                <div className="container position-relative zindex-5 pt-5">
                    <div className="row">
                        <div className="col-lg-6 mt-5 pt-4">
                            ...
                            <p className="fs-xl pb-4 mb-1 mb-md-2 mb-lg-3" style={{maxWidth: '526px'}}>Christmas in Port Harcourt 2022 edition themed "The home coming" is a socio-cultural event in Port Harcourt city, with the objective of promoting, exposing and appreciating art, beauty, cultural heritage and lifestyle of Rivers State, Niger Delta and Nigeria to the world. </p>
                            <p className="fs-xl pb-4 mb-1 mb-md-2 mb-lg-3" style={{maxWidth: '526px'}}>Christmas in Port Harcourt is an annual event that kicked-off in the year 2017 and has been successfully organized for four years. It is also organized by Ediz wine bar is established in Port Harcourt city, under corporate allied laws governing nation. We are stakeholders in hospitality, culture and tourism sector of the economy.</p>
