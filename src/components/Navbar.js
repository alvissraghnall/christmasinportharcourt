        ...
        <header className="header navbar navbar-expand-lg bg-light shadow-sm fixed-top">
            ...
            <div id="navbarNav" className="offcanvas offcanvas-end">
                ...
                <div className="offcanvas-header border-top">
                    <a href="https://ticket.christmasinportharcourt.com" className="btn btn-danger w-100">
            ...
            <a href="https://ticket.christmasinportharcourt.com" className="btn btn-danger btn-sm fs-sm rounded d-none d-lg-inline-flex">
